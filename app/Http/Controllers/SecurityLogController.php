...
class SecurityLogController extends Controller
{
    ...
    /**
     * Display the security logs dashboard.
     */
    public function index()
    {
        $stats = [
            ...
            'blocked_ips' => SecurityLog::where('event_type', 'blocked_access')->distinct('ip_address')->count(),
            'top_attacked_routes' => SecurityLog::whereNotNull('route')
